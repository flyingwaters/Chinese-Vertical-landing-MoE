...
def train():
    ...
    raw_train_datasets = load_dataset(
        'json', data_files=data_args.data_path,
        split="train"
    )
    dev_data = load_dataset(
        'json', data_files="/home/clouduser/fengly/Chinese-Mixtral-8x7B/test0.json",
        split="train"
    )
    ...
    data_module = dict(train_dataset=train_dataset, eval_dataset=dev_dataset, data_collator=data_collator)
