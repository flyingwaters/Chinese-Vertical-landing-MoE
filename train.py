...
def build_dataset(train_datasets: List[str], valid_datasets: List[str]):
    ...
    print("train_dataset_name:  ",train_datasets)
    ...
    print("train_data_name2pathNratio: ",train_data_name2pathNratio)
...
def train():
    ...
    if tokenizer.pad_token is None:
        smart_tokenizer_and_embedding_resize(
            special_tokens_dict=dict(pad_token="<EOT>"),
            tokenizer=tokenizer,
            model=model,
        )
    ...
    print_rank_0("length train_dataset:", len(train_dataset))
